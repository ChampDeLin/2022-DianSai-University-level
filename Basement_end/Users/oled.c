...
{
	///< i2c的两条线均要上拉；
	config_gpio_mode(oled_scl_GPIO_Port, oled_scl_Pin, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP);
	config_gpio_mode(oled_sda_GPIO_Port, oled_sda_Pin, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP);
}
//OLED的初始化
void OLED_Init(void)
{
